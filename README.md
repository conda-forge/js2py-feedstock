...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/js2py-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9270&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/js2py-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `js2py` can be installed with:

```
conda install js2py
```

It is possible to list all of the versions of `js2py` available on your platform with:
